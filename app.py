    ...
    with gr.Tabs() as main_tabs:
        ...
        with gr.Tab("🛠️ Aide / Installation"):
            ...
            with gr.Accordion(
                ...
                # En dehors du Group (visible sans deverrouillage password)
                # mais a l'interieur de l'Accordion (donc admin URL only).
                # 2-clics avec armement pour eviter le clic accidentel.
                gr.Markdown("---")
                gr.Markdown(
