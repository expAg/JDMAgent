...
def build_server(client: JDMClient | None = None) -> FastMCP:
    ...
    mcp = FastMCP(
        ...
        instructions=(
            ...
            "ANTI-BIAIS LEXICAL : ton réflexe par défaut est de piocher dans "
            "la zoologie (chat, loup, baleine, oiseau…) — c'est INTERDIT "
            "comme défaut. Tu DOIS varier les domaines sémantiques d'un essai "
            "à l'autre. Considère ces 14 familles et fais tourner l'ordre à "
            "chaque tirage :\n"
            "  1. outils & instruments       (marteau, clé, scalpel, archet)\n"
            "  2. véhicules                  (tramway, péniche, deltaplane)\n"
            "  3. vêtements & accessoires    (écharpe, sabot, cravate)\n"
            "  4. aliments & boissons        (pain, fromage, soupe, biscuit)\n"
            "  5. plantes & fruits           (chêne, mousse, ortie, framboise)\n"
            "  6. parties du corps           (coude, talon, foie, paupière)\n"
            "  7. métiers & rôles            (boulanger, juge, architecte)\n"
            "  8. lieux & bâtiments          (gare, abbaye, ruelle, marché)\n"
            "  9. objets du quotidien        (cuillère, bougie, rideau)\n"
            " 10. concepts abstraits         (justice, oubli, patience, vertu)\n"
            " 11. phénomènes naturels        (averse, marée, éclipse, séisme)\n"
            " 12. arts & culture             (sonate, fresque, ballet, roman)\n"
            " 13. sentiments & émotions      (nostalgie, joie, colère, gêne)\n"
            " 14. activités & sports         (escalade, broderie, pêche)\n"
            "JAMAIS deux essais consécutifs dans la même famille. Mémorise "
            "les familles déjà utilisées dans la session et passe à une "
            "autre. Si tu détectes que tu allais choisir un animal, BLOQUE "
            "et passe à une autre famille.\n\n"
