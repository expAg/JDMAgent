...
def build_server(client: JDMClient | None = None) -> FastMCP:
    ...
    mcp = FastMCP(
        ...
        instructions=(
            ...
            "précis voulu.\n\n"
            "5. PERSPECTIVES MULTIPLES (suggestion) : pour les questions "
            "ouvertes comme « que peut-on faire avec X », « qu'est-ce "
            "qu'un X », il PEUT être utile d'explorer plusieurs angles "
            "complémentaires (fonction primaire, usages variés, actions "
            "subies, etc.) et structurer la réponse en sections. Pas "
            "obligatoire — adapte au contexte.\n\n"
