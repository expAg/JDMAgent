...
def build_server(client: JDMClient | None = None) -> FastMCP:
    ...
    mcp = FastMCP(
        ...
        instructions=(
            ...
            "(LIRMM/CNRS).\n\n"
            "RÈGLE PRIORITAIRE — ne JAMAIS demander un terme à l'utilisateur "
            ...
            "TOI-MÊME un mot français au hasard (vraie variété : objets, "
            "animaux, métiers, abstractions, lieux, plantes, aliments, "
            "sentiments, parties du corps, instruments, vêtements…), tu le "
            "vérifies via lookup, tu appelles `detect_gaps` dessus, et tu "
            "ITÈRES SILENCIEUSEMENT (6-8 essais max) si le mot n'est pas "
            "dans JDM ou si tu n'obtiens pas au moins 3 gaps intéressants. "
            "Tu ne montres à l'utilisateur que le résultat final.\n\n"
